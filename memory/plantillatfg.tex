...
\begin{itemize}
    \item \textbf{Confirmed Specialization:} Each layout performed best on its own book. 
    ...
    \item \textbf{Over-specialization of the Simple-Text Layout:} The \textit{Wizard of Oz} layout struggled on the complex text, 
    ...
    \item \textbf{Robustness of the Complex-Text Layout:} Conversely, the \textit{Moby Dick} layout was very robust, 
