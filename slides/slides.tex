...
\pgfdeclareimage[height=0.95cm]{upv-logo}{../figures/logo-upv.pdf}
...
\begin{frame}{Corpus de Texto Utilizados}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      \centering
      \begin{beamercolorbox}[sep=8pt,center,rounded=true,shadow=true]{block body}
        \includegraphics[width=0.7\textwidth]{../figures/moby_dick.jpeg}
    ...
    \begin{column}{0.5\textwidth}
      \centering
      \begin{beamercolorbox}[sep=8pt,center,rounded=true,shadow=true]{block body}
        \includegraphics[width=0.5\textwidth]{../figures/wonderful_wizard.jpg}
...
\begin{frame}{Experimentos Genéticos (I)}
  ...
  \begin{columns}[T,totalwidth=\textwidth]
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=0.95\textwidth]{../figures/exp1_population_size_moby_dick.pdf}
    ...
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=0.95\textwidth]{../figures/exp1_population_size_wonderful_wizard_oz.pdf}
      \begin{beamercolorbox}[sep=1pt,center,rounded=true]{block body example}
  ...
  \begin{columns}[T,totalwidth=\textwidth]
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=0.95\textwidth]{../figures/exp2_tournament_selection_moby_dick.pdf}
      \begin{beamercolorbox}[sep=1pt,center,rounded=true]{block body example}
    ...
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=0.95\textwidth]{../figures/exp2_tournament_selection_wonderful_wizard_oz.pdf}
      \begin{beamercolorbox}[sep=1pt,center,rounded=true]{block body example}
...
\begin{frame}{Experimentos Genéticos (II)}
  ...
  \begin{columns}[T,totalwidth=\textwidth]
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=0.95\textwidth]{../figures/exp3_mutation_rate_moby_dick.pdf}
      \begin{beamercolorbox}[sep=1pt,center,rounded=true]{block body example}
    ...
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=0.95\textwidth]{../figures/exp3_mutation_rate_wonderful_wizard_oz.pdf}
      \begin{beamercolorbox}[sep=1pt,center,rounded=true]{block body example}
  ...
  \begin{columns}[T,totalwidth=\textwidth]
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=0.95\textwidth]{../figures/exp4_elite_percentage_moby_dick.pdf}
      \begin{beamercolorbox}[sep=1pt,center,rounded=true]{block body example}
    ...
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=0.95\textwidth]{../figures/exp4_elite_percentage_wonderful_wizard_oz.pdf}
      \begin{beamercolorbox}[sep=1pt,center,rounded=true]{block body example}
...
\begin{frame}{Experimentos Enfriamiento (I)}
  \begin{center}
    \includegraphics[width=0.65\textwidth]{../figures/moby_dick_scheduler_comparison_detailed.pdf}
  \end{center}
  
  
  \begin{center}
    \includegraphics[width=0.60\textwidth]{../figures/wizard_oz_scheduler_comparison_detailed.pdf}
  \end{center}
\end{frame}
