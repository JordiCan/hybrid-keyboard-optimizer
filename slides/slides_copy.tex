...
\titlegraphic{
  \begin{minipage}{0.45\linewidth}\centering
    \includegraphics[width=0.5\linewidth]{../figures/logo-upv.pdf}
  \end{minipage}%
  \begin{minipage}{0.45\linewidth}\centering
  \end{minipage}
}
...
\begin{frame}[fragile]{Codificación de un Individuo}
  \begin{block}{\underline{Representación del Layout}}
    Un layout se representa como una lista de \textbf{30 elementos} mapeados a posiciones físicas del teclado (3 filas × 10 columnas).
  \end{block}
...
\begin{frame}[fragile]{Arquitectura de los experimentos}
  \centering
  \vspace{2em}
  ...
  \begin{tikzpicture}[scale=0.8, every node/.style={transform shape},
    ...
    module/.style={rectangle, draw, rounded corners, very thick,
      minimum width=7em, minimum height=3em, align=center, font=\large},
    arrow/.style={thick,->,>=stealth, line width=1.2pt}]
    
    % Nodos superiores (inputs)
    \node[module, fill=yellow!20] (data) {Datos\\(Corpus)};
    \node[module, fill=cyan!20, right=of data] (known) {Distribuciones\\Conocidas};
    
    % Algoritmos
    \node[module, fill=green!20, below=2.5cm of data] (ga) {Algoritmo\\Genético};
    \node[module, fill=orange!20, right=of ga] (sa) {Enfriamiento\\Simulado};
    
    % Output
    \node[module, fill=red!20, below=2.5cm of ga, xshift=2cm] (output) {Soluciones};
    ...
    \begin{column}{0.6\textwidth}
      ...
      \begin{block}{Componentes Principales}
        \begin{itemize}
          ...
          \item \textbf{Selección:} Torneo
          \item \textbf{Cruce:} Cruce por dos puntos
    ...
    \begin{column}{0.4\textwidth}
      ...
      \begin{tikzpicture}[scale=0.7, every node/.style={transform shape},
        ...
        block/.style={rectangle, draw, rounded corners, fill=blue!20, 
          text width=6em, align=center, minimum height=2.8em, very thick, font=\large},
        arrow/.style={thick,->,>=stealth, color=UPVGray}]
        
        \node[block, fill=green!40] (init) {Población Inicial};
        \node[block, fill=blue!20, below=of init] (eval) {Evaluación Fitness};
        \node[block, fill=blue!30, below=of eval] (select) {Selección};
        \node[block, fill=blue!40, below=of select] (cross) {Cruce};
        \node[block, fill=blue!50, below=of cross] (mut) {Mutación};
        \node[block, below=of mut, fill=UPVRed!40] (term) {¿Terminar?};
        
        \draw[arrow, ultra thick] (init) -- (eval);
        \draw[arrow, ultra thick] (eval) -- (select);
        \draw[arrow, ultra thick] (select) -- (cross);
        \draw[arrow, ultra thick] (cross) -- (mut);
        \draw[arrow, ultra thick] (mut) -- (term);
        \draw[arrow, ultra thick] (term.east) -- ++(1,0) |- (eval.east) node[midway, right] {\large\textbf{No}};

        \node[below=0.4cm of term, font=\large] {\textbf{Sí}};
      \end{tikzpicture}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Comparativa de Experimentos genéticos}
  \begin{block}{\underline{Tamaño de la población}}
  \end{block}
  
  \vspace{1em}
  
  \begin{columns}[T]
    % Columna izquierda - Experimento 1
    \begin{column}{0.5\textwidth}
      \centering      
      \vspace{0.5em}
      
      \includegraphics[width=\textwidth]{recursos/exp1_population_size_moby_dick.pdf}
      
      \vspace{0.5em}
      
      \begin{beamercolorbox}[sep=6pt,center,rounded=true]{block body example}
        \small
        Pop\_size: 100000 Fitness: 769,434.60 
      \end{beamercolorbox}
    \end{column}
    
    % Columna derecha - Experimento 2
    \begin{column}{0.5\textwidth}
      \centering
      ...
      \includegraphics[width=\textwidth]{recursos/exp1_population_size_wonderful_wizard_oz.pdf}
      
      \vspace{0.5em}
      
      \begin{beamercolorbox}[sep=6pt,center,rounded=true]{block body example}
        \small
        Pop\_size: 1000000 Fitness: 121,733.00
      \end{beamercolorbox}
    \end{column}
  \end{columns}
...
\begin{frame}{Comparativa de Experimentos}
  \begin{block}{\underline{Tamaño de Torneo}}
  \end{block}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      ...
      \includegraphics[width=\textwidth]{recursos/exp2_tournament_selection_moby_dick.pdf}
      
      \vspace{0.5em}
      
      \begin{beamercolorbox}[sep=6pt,center,rounded=true]{block body example}
        \small
        k: 5  \\Fitness: 774,634.30
      \end{beamercolorbox}
    \end{column}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \includegraphics[width=\textwidth]{recursos/exp2_tournament_selection_wonderful_wizard_oz.pdf}
      
      \vspace{0.5em}
      
      \begin{beamercolorbox}[sep=6pt,center,rounded=true]{block body example}
        \small
        k: 10 \\ Fitness: 122,030.30
      \end{beamercolorbox}
    \end{column}
  \end{columns}
...
\begin{frame}{Comparativa de Experimentos}
  \begin{block}{\underline{Mutation rate}}
  \end{block}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      ...
      \includegraphics[width=\textwidth]{recursos/exp3_mutation_rate_moby_dick.pdf}
      
      \vspace{0.5em}
      
      \begin{beamercolorbox}[sep=6pt,center,rounded=true]{block body example}
        \small
        Mutation\_rate: 0.15 \\ Fitness: 769,434.60
      \end{beamercolorbox}
    \end{column}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \includegraphics[width=\textwidth]{recursos/exp3_mutation_rate_wonderful_wizard_oz.pdf}
      
      \vspace{0.5em}
      
      \begin{beamercolorbox}[sep=6pt,center,rounded=true]{block body example}
        \small
        Mutation\_rate: 0.5 \\ Fitness: 123,341.20
      \end{beamercolorbox}
    \end{column}
  \end{columns}
...
\begin{frame}{Comparativa de Experimentos}
  \begin{block}{\underline{Reemplazo poblacional}}
  \end{block}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      ...
      \includegraphics[width=\textwidth]{recursos/exp4_elite_percentage_moby_dick.pdf}
      
      \vspace{0.5em}
      
      \begin{beamercolorbox}[sep=6pt,center,rounded=true]{block body example}
        \small
        Población superviviente: 20\% \\Fitness: 765,886.50
      \end{beamercolorbox}
    \end{column}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \includegraphics[width=\textwidth]{recursos/exp4_elite_percentage_wonderful_wizard_oz.pdf}
      
      \vspace{0.5em}
      
      \begin{beamercolorbox}[sep=6pt,center,rounded=true]{block body example}
        \small
        Población superviviente: 5\% \\ Fitness: 121,733.00
      \end{beamercolorbox}
    \end{column}
  \end{columns}
